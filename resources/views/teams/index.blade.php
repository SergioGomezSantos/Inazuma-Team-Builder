                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                                <thead class="bg-gray-50 dark:bg-gray-700 sticky top-0">
                                    <tr class="dark:text-primary-500">
                                        ...
                                        <th scope="col" class="px-0 py-3 text-left w-52">Formación</th>
                                        <th scope="col" class="pl-4 py-3 text-right w-auto">Nombre</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-0 py-4 whitespace-nowrap">
                                            <div class="flex items-center justify-center space-x-2">
                                                ...
                                                <!-- Builder Button -->
                                                <a href="{{ route('teams.edit', $team->id) }}" id="save-team" class="font-bold py-2 px-4 text-black rounded-md ease-in-out
                                                    bg-primary-500 hover:bg-yellow-500 dark:bg-primary-500
                                                ...
                                                <form action="{{ route('teams.destroy', $team->id) }}" method="POST"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="font-bold py-2 px-4 text-white rounded-md ease-in-out
